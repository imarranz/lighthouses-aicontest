...
class Bot(object):
	...
	def __init__(self, init_state):
		...
		self.a_cual_ir="cercano"
                #Parametrizaciones en función de num jugadores y tamaño tablero
		self.energ_min_faro_vacio=200
		self.energ_min_recarga=120 #antes 100
		self.energ_min_ataque=100 #antes 50
		self.porcentaje_recarga=60
